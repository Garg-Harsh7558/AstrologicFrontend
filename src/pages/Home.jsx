...
function Home() {
  ...
  return (
    <div className="min-h-screen w-full bg-[#050508] relative overflow-hidden font-['Outfit']">
      ...
      <main className="relative z-10 pt-12 px-6 lg:px-10 max-w-7xl mx-auto">
                  ...
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      {!currentHora ? (
                        ...
                        <>
                          <h3 className="text-3xl font-bold text-white mb-1">{currentHora?.lord}</h3>
                ...
                <div className="p-8 lg:p-10">
                  <div className="flex justify-between items-start mb-6">
                    <div>
                      ...
                      <h3 className="text-3xl font-bold text-white mb-1">{data.tithi?.name}</h3>
            ...
            <div className="backdrop-blur-3xl bg-white/5 border border-white/10 rounded-[3rem] p-10 hover:bg-white/5 transition-all duration-700 shadow-2xl">
              <div className="flex items-center justify-between mb-10">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white mb-1">Planetary Schedule</h3>
                    <p className="text-slate-500 text-xs uppercase tracking-widest font-bold">24-Hour Hora Cycle (Today)</p>
                  </div>
                </div>
                {currentHora && (
                  <div className="bg-purple-500/10 border border-purple-500/30 px-6 py-2 rounded-full hidden md:block">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {Object.entries(data.hora).map(([num, hora]) => {
                  ...
                  return (
                    <div 
                      key={num} 
                      className={`relative overflow-hidden group p-6 rounded-3xl border transition-all duration-500 ${
                        isActive 
